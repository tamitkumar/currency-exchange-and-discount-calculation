...
public class ExchangeRateServiceImpl implements ExchangeRateService {
	...
	public ExchangeRateServiceImpl(ExchangeRateClient exchangeRateClient, ExchangeRepository exchangeRepository) {
	...
	public GreetingMessage calculatePayableAmount(BillDetails billDetails) {
		...
		Optional<UserEntity> user = exchangeRepository.findByIdAndPhone(billDetails.getId(), billDetails.getPhone());
	...
	private void calculateDiscount(UserEntity user, BillDetails billDetails, GreetingMessage greetingMessage) {
