...
@SpringBootTest
public class ExchangeAndDiscountAppTest {
	...
	void contextLoads() {
		...
		assertTrue(applicationContext.containsBean("exchangeAndDiscountApp"),
				"The application context should contain the ExchangeAndDiscountApp bean.");
	}

	@Test
	void testConfigureMethod() {
		ExchangeAndDiscountApp application = new ExchangeAndDiscountApp();
	...
	@Test
    void mainMethodTest() {
        assertDoesNotThrow(() -> ExchangeAndDiscountApp.main(new String[] {}),
